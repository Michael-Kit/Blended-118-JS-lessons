...
// Ваш власний проєкт наповнюється, в ньому ще нові вирішені задачі по 3-4 модулям, можливо навіть з кількома варіантами вирішення.
// Код розміщений у репозиторії на GitHub, що забезпечить правильну організацію проєктів і домашніх завдань.
// Ці завдання допоможуть вам закріпити навички роботи з такими важливими типами даних, як масиви та обʼєкти, додадуть впевненості у роботі
// з функціями і підготують до більш складних завдань у майбутньому.