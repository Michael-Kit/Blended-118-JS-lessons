...
// Ці завдання допоможуть вам краще зрозуміти такі важливі теми, як основні типи даних в js, основи функцій, розгалуження
// та цикли, а також набути впевненості у роботі з GitHub.
